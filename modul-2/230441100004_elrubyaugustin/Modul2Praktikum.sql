...
-- soal 1
-- SOAL A Menampilkan informasi lengkap UMKM dari berbagai tabel.
...
SELECT * FROM view_umkm_detail;`view_umkm_kategori_kota`

-- SOAL B Menampilkan data pribadi pemilik dan nama usahanya.
...
-- SOAL C Menampilkan daftar produk yang dijual UMKM.
...
-- SOAL D Menampilkan UMKM yang termasuk kategori skala Menengah.
...
-- SOAL E Menampilkan jumlah UMKM per kota/kabupaten.
